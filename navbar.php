<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <a class="navbar-brand" href="./index.php">Gestão de cadastro de Cidades</a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="./cidade.form.php">Cadastrar</a></li>
                        <li><a class="dropdown-item" href="./cidade.list.php">Listar</a></li>
                    </ul>
                </li>
            </ul>
            <form class="d-flex">
